...
- **Machine Learning**
  - Reinforcement Learning
    -  :question: how to learn sub-policies -- infinitely nestable?
  - Text/Language
    ...
    -  :question: how does word sound relate to sentiment? can you predict the sentiment of an arbitrary word?
  ...
  - Images
    ...
    -  :question: what space do artistic styles reside in?
  ...
  - design game where solution requires agents to posess characteristics of self-awareness and ability to communicate
    -  :question: put coloured mark on agents have they have to ask other agents what colour their own dot is (or use mirror?)
  ...
  - learning to learn to learn ... to learn
    -  :question: this is essentially how human intelligence came about and acts -> how can this process be implemented at the limit case?
...
- **Idea Management**
  - MindMap
    ...
    -  :question: use #url to denote that a note is a url, and can be opened (how?)
  ...
  -  :question: how to deal with different types of notes?
...
- **Human Intelligence/Psychology**
  -  :question: what are indicators of only* intelligence?
  ...
  -  :question: what is the difference in maximum "capacity" of brains that can and cannot alter structure/synapse strength?
  -  :question: how to avoid catastrophic learning?
    -  :question: how does the brain do it? store info in both hippocampus and cortex
  ...
  -  :question: what function would "brain waves" have in an ANN?
  ...
  -  :question: where does Maslow's hierarchy of needs come from?
  ...
  -  :question: how do functional modules form in brain?
...
- **Fermi**
  ...
  -  :question: how do you impart love?
    -  :question: how do you get a human to form an attachment to someone or something? or convince them that it has thoughts and feelings
...
- **Math**
  ...
  - Interpolation/extrapolation with ASMD
    -  :question: what functions do the ASMD produce?
  ...
  - ~~moving guess~~
    - ~~ :question: You find someone in a state at time t0. You observe them in the state for duration t. Given the person has been in there for (t + x), what is the most likely total time they have been in the state?~~
...
- **Images**
  - convert image to algorithm, recursively apply
    -  :question: how to ensure fixed point existence? -- if none, can view time series
  ...
  - represent image as histogram in pattern-space (similar to filter activations?)
    -  :question: what would a path through the pattern-space look like?

___

- **Philosophy**
  -  :question: What does it mean for a pattern/identity to exist?
...
- **Art**
  ...
  -  :question: why do birds sing?
    -  :question: how are those signals better than random series of notes?
  ...
  -  :question: why do humans enjoy non-utilitous things?
    - ex. art (depictive and abstract)
    - because it displays concepts and patterns which we have learned to find good?
    -  :question: why do we enjoy wordplay?
  -  :question: why do we enjoy certain artistic styles independent of their specific content?
...
- **Optimization**
  - road crossing problem
    -  :question: If you want to cross the road to get from A to B, what is the optimal path to take?
...
- **Simulations**
  ...
  - socio-emotional model
    -  :question: person Pa has emotion a, person Pb has emotion b -- how do they interact?
  ...
  -  :question: what happens when you can fix cells in GOL?
  ...
  -  :question: what forces promote and prevent formation of social structures of different levels?
