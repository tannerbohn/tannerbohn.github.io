...
- **Machine Learning**
  ...
  - Text/Language
    ...
    - ~~create sentence parsing algorithm~~
      ...
      - ~~see work on Fermi~~
      -  <img src="https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/easy2.png" height="15"> todo: find other uses for parsing algorithm (finding facts in text?)
