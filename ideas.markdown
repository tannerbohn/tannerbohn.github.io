...
- **Machine Learning**
  - Reinforcement Learning
    - :small_blue_diamond: how to learn sub-policies -- infinitely nestable?
  - Text/Language
    ...
    - :small_blue_diamond: how does word sound relate to sentiment? can you predict the sentiment of an arbitrary word?
  ...
  - Images
    ...
    - :small_blue_diamond: what space do artistic styles reside in?
  ...
  - design game where solution requires agents to posess characteristics of self-awareness and ability to communicate
    - :small_blue_diamond: put coloured mark on agents have they have to ask other agents what colour their own dot is (or use mirror?)
  ...
  - learning to learn to learn ... to learn
    - :small_blue_diamond: this is essentially how human intelligence came about and acts -> how can this process be implemented at the limit case?
...
- **Idea Management**
  - MindMap
    ...
    - :small_blue_diamond: use #url to denote that a note is a url, and can be opened (how?)
  ...
  - :small_blue_diamond: how to deal with different types of notes?
...
- **Human Intelligence/Psychology**
  - :small_blue_diamond: what are indicators of only* intelligence?
  ...
  - :small_blue_diamond: what is the difference in maximum "capacity" of brains that can and cannot alter structure/synapse strength?
  - :small_blue_diamond: how to avoid catastrophic learning?
    - :small_blue_diamond: how does the brain do it? store info in both hippocampus and cortex
  ...
  - :small_blue_diamond: what function would "brain waves" have in an ANN?
  ...
  - :small_blue_diamond: where does Maslow's hierarchy of needs come from?
  ...
  - :small_blue_diamond: how do functional modules form in brain?
...
- **Fermi**
  ...
  - :small_blue_diamond: how do you impart love?
    - :small_blue_diamond: how do you get a human to form an attachment to someone or something? or convince them that it has thoughts and feelings
...
- **Math**
  ...
  - Interpolation/extrapolation with ASMD
    - :small_blue_diamond: what functions do the ASMD produce?
  ...
  - ~~moving guess~~
    - ~~:small_blue_diamond: You find someone in a state at time t0. You observe them in the state for duration t. Given the person has been in there for (t + x), what is the most likely total time they have been in the state?~~
...
- **Images**
  - convert image to algorithm, recursively apply
    - :small_blue_diamond: how to ensure fixed point existence? -- if none, can view time series
  ...
  - represent image as histogram in pattern-space (similar to filter activations?)
    - :small_blue_diamond: what would a path through the pattern-space look like?

___

- **Philosophy**
  - :small_blue_diamond: What does it mean for a pattern/identity to exist?
...
- **Art**
  ...
  - :small_blue_diamond: why do birds sing?
    - :small_blue_diamond: how are those signals better than random series of notes?
  ...
  - :small_blue_diamond: why do humans enjoy non-utilitous things?
    - ex. art (depictive and abstract)
    - because it displays concepts and patterns which we have learned to find good?
    - :small_blue_diamond: why do we enjoy wordplay?
  - :small_blue_diamond: why do we enjoy certain artistic styles independent of their specific content?
...
- **Optimization**
  - road crossing problem
    - :small_blue_diamond: If you want to cross the road to get from A to B, what is the optimal path to take?
...
- **Simulations**
  ...
  - socio-emotional model
    - :small_blue_diamond: person Pa has emotion a, person Pb has emotion b -- how do they interact?
  ...
  - :small_blue_diamond: what happens when you can fix cells in GOL?
  ...
  - :small_blue_diamond: what forces promote and prevent formation of social structures of different levels?
