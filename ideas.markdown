...
- **Machine Learning**
  - Reinforcement Learning
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how to learn sub-policies -- infinitely nestable?
  - Text/Language
    ...
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how does word sound relate to sentiment? can you predict the sentiment of an arbitrary word?
  ...
  - Images
    ...
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what space do artistic styles reside in?
  ...
  - design game where solution requires agents to posess characteristics of self-awareness and ability to communicate
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} put coloured mark on agents have they have to ask other agents what colour their own dot is (or use mirror?)
  ...
  - learning to learn to learn ... to learn
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} this is essentially how human intelligence came about and acts -> how can this process be implemented at the limit case?
...
- **Idea Management**
  - MindMap
    ...
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} use #url to denote that a note is a url, and can be opened (how?)
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how to deal with different types of notes?
...
- **Human Intelligence/Psychology**
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what are indicators of only* intelligence?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what is the difference in maximum "capacity" of brains that can and cannot alter structure/synapse strength?
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how to avoid catastrophic learning?
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how does the brain do it? store info in both hippocampus and cortex
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what function would "brain waves" have in an ANN?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} where does Maslow's hierarchy of needs come from?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how do functional modules form in brain?
...
- **Fermi**
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how do you impart love?
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how do you get a human to form an attachment to someone or something? or convince them that it has thoughts and feelings
...
- **Math**
  ...
  - Interpolation/extrapolation with ASMD
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what functions do the ASMD produce?
  ...
  - ~~moving guess~~
    - ~~ ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} You find someone in a state at time t0. You observe them in the state for duration t. Given the person has been in there for (t + x), what is the most likely total time they have been in the state?~~
...
- **Images**
  - convert image to algorithm, recursively apply
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how to ensure fixed point existence? -- if none, can view time series
  ...
  - represent image as histogram in pattern-space (similar to filter activations?)
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what would a path through the pattern-space look like?

___

- **Philosophy**
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} What does it mean for a pattern/identity to exist?
...
- **Art**
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} why do birds sing?
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} how are those signals better than random series of notes?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} why do humans enjoy non-utilitous things?
    - ex. art (depictive and abstract)
    - because it displays concepts and patterns which we have learned to find good?
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} why do we enjoy wordplay?
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} why do we enjoy certain artistic styles independent of their specific content?
...
- **Optimization**
  - road crossing problem
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} If you want to cross the road to get from A to B, what is the optimal path to take?
...
- **Simulations**
  ...
  - socio-emotional model
    -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} person Pa has emotion a, person Pb has emotion b -- how do they interact?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what happens when you can fix cells in GOL?
  ...
  -  ![alt text](https://raw.githubusercontent.com/tannerbohn/tannerbohn.github.io/master/assets/question.png){:height="36px" width="36px"} what forces promote and prevent formation of social structures of different levels?
